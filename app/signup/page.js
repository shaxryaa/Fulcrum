    ...
    <div className="min-h-screen bg-white text-black flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-extrabold tracking-tighter mb-4">Start your streak.</h1>
          <p className="text-xl text-gray-500 font-medium">Join thousands of focused creators.</p>
        </div>
      ...
      <div className="absolute -top-64 -left-64 w-[500px] h-[500px] bg-gray-100 rounded-full blur-3xl pointer-events-none opacity-50" />
    </div>
  );
}
